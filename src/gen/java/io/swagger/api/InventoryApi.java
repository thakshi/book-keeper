...
public class InventoryApi  {
   private final InventoryApiService delegate = InventoryApiServiceFactory.getInventoryApi();
    ...
    public Response inventoryAddPut(@ApiParam(value = "")@FormParam("inventoryCode")  String inventoryCode,@ApiParam(value = "")@FormParam("name")  String name,@ApiParam(value = "")@FormParam("itemPrice")  String itemPrice,@Context SecurityContext securityContext)
    ...
    public Response inventoryDeleteInventoryCodeDelete(@ApiParam(value = "",required=true) @PathParam("inventory-code") String inventoryCode,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response inventoryGetInventoryCodeGet(@ApiParam(value = "",required=true) @PathParam("inventory-code") String inventoryCode,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response inventoryUpdateInventoryCodePost(@ApiParam(value = "",required=true) @PathParam("inventory-code") String inventoryCode,@ApiParam(value = "Request Body" ) Payload1 payload,@Context SecurityContext securityContext)
    throws NotFoundException {
